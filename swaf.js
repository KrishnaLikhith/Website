! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).Sweetalert2 = t() }(this, function() {
    ...
    const g = e(["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "no-transition", "toast", "toast-shown", "show", "hide", "close", "title", "html-container", "actions", "confirm", "deny", "cancel", "default-outline", "footer", "icon", "icon-content", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "input-label", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loader", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl", "timer-progress-bar", "timer-progress-bar-container", "scrollbar-measure", "icon-success", "icon-warning", "icon-info", "icon-question", "icon-error"]),
        ...
        y = e => { const t = f(); return t ? t.querySelector(e) : null },
        v = e => y(".".concat(e)),
        w = () => v(g.popup),
        C = () => v(g.icon),
        k = () => v(g.title),
    ...
    const T = () => y(".".concat(g.loader)),
        ...
        M = () => v(g.close),
        D = () => { const e = a(w().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort((e, t) => (e = parseInt(e.getAttribute("tabindex")), (t = parseInt(t.getAttribute("tabindex"))) < e ? 1 : e < t ? -1 : 0)); var t = a(w().querySelectorAll('\n  a[href],\n  area[href],\n  input:not([disabled]),\n  select:not([disabled]),\n  textarea:not([disabled]),\n  button:not([disabled]),\n  iframe,\n  object,\n  embed,\n  [tabindex="0"],\n  [contenteditable],\n  audio[controls],\n  video[controls],\n  summary\n')).filter(e => "-1" !== e.getAttribute("tabindex")); return (t => { const n = []; for (let e = 0; e < t.length; e++) - 1 === n.indexOf(t[e]) && n.push(t[e]); return n })(e.concat(t)).filter(e => Q(e)) },
    ...
    const V = { previousBodyPadding: null },
        ...
        F = (e, t, n) => {
            var o, i;
            if (o = e, i = t, a(o.classList).forEach(e => { Object.values(g).includes(e) || Object.values(b).includes(e) || Object.values(i.showClass).includes(e) || o.classList.remove(e) }), t.customClass && t.customClass[n]) {
        ...
        W = (e, t, n) => { e && t && (t = "string" == typeof t ? t.split(/\s+/).filter(Boolean) : t).forEach(t => { e.forEach ? e.forEach(e => { n ? e.classList.add(t) : e.classList.remove(t) }) : n ? e.classList.add(t) : e.classList.remove(t) }) },
        _ = (e, t) => { W(e, t, !0) },
        K = (e, t) => { W(e, t, !1) },
        Y = (t, n) => {
        ...
        oe = (e, t = !1) => {
            const n = I();
            Q(n) && (t && (n.style.transition = "none", n.style.width = "100%"), setTimeout(() => { n.style.transition = "width ".concat(e / 1e3, "s linear"), n.style.width = "0%" }, 10))
        },
        ...
        se = () => { ln.isVisible() && ln.resetValidationMessage() },
        re = e => {
            var t = (() => { const e = f(); return !!e && (e.remove(), K([document.documentElement, document.body], [g["no-backdrop"], g["toast-shown"], g["has-column"]]), !0) })();
            if (ie()) r("SweetAlert2 requires document to initialize");
                ...
                o.appendChild(n), (e => {
                    ...
                    const e = w(),
                        ...
                        r = Y(e, g.textarea);
                    t.oninput = se, n.onchange = se, a.onchange = se, s.onchange = se, r.oninput = se, o.oninput = () => { se(), i.value = o.value }, o.onchange = () => { se(), o.nextSibling.value = o.value }
                })()
            }
        },
        ce = (e, t) => { e instanceof HTMLElement ? t.appendChild(e) : "object" == typeof e ? le(e, t) : e && N(t, e) },
        le = (e, t) => { e.jquery ? ue(t, e) : N(t, e.toString()) },
        ue = (t, n) => {
    ...
    function me(e, t, n) { G(e, n["show".concat(o(t), "Button")], "inline-block"), N(e, n["".concat(t, "ButtonText")]), e.setAttribute("aria-label", n["".concat(t, "ButtonAriaLabel")]), e.className = g[t], F(e, n, "".concat(t, "Button")), _(e, n["".concat(t, "ButtonClass")]) }
    const he = (e, t) => {
        var n, o, i = f();
    ...
    const be = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
        ...
        we = (e, t) => { e.placeholder && !t.inputPlaceholder || (e.placeholder = t.inputPlaceholder) },
        Ce = (e, t, n) => {
            if (n.inputLabel) {
                e.id = g.input;
        ...
        ke = e => { e = g[e] || g.input; return Y(w(), e) },
        Ae = {};
    ...
    const Be = (e, t) => {
        ...
        Pe = () => { const e = w(); var t = window.getComputedStyle(e).getPropertyValue("background-color"); const n = e.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"); for (let e = 0; e < n.length; e++) n[e].style.backgroundColor = t },
        Ee = (e, t) => {
            var n;
            e.textContent = "", t.iconHtml ? N(e, Te(t.iconHtml)) : "success" === t.icon ? N(e, '\n      <div class="swal2-success-circular-line-left"></div>\n      <span class="swal2-success-line-tip"></span> <span class="swal2-success-line-long"></span>\n      <div class="swal2-success-ring"></div> <div class="swal2-success-fix"></div>\n      <div class="swal2-success-circular-line-right"></div>\n    ') : "error" === t.icon ? N(e, '\n      <span class="swal2-x-mark">\n        <span class="swal2-x-mark-line-left"></span>\n        <span class="swal2-x-mark-line-right"></span>\n      </span>\n    ') : (n = { question: "?", warning: "!", info: "i" }, N(e, Te(n[t.icon])))
        },
        Se = (e, t) => {
            if (t.iconColor) {
        ...
        Le = (e, o) => {
            ...
            J(i), i.textContent = "", o.currentProgressStep >= o.progressSteps.length && s("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), o.progressSteps.forEach((e, t) => {
                ...
                i.appendChild(e), t === o.currentProgressStep && _(e, g["active-progress-step"]), t !== o.progressSteps.length - 1 && (t = (e => { const t = document.createElement("li"); return _(t, g["progress-step-line"]), e.progressStepsDistance && (t.style.width = e.progressStepsDistance), t })(o), i.appendChild(t))
            })
        },
        Oe = (e, t) => { e.className = "".concat(g.popup, " ").concat(Q(e) ? t.showClass.popup : ""), t.toast ? (_([document.documentElement, document.body], g["toast-shown"]), _(e, g.toast)) : _(e, g.modal), F(e, t, "popup"), "string" == typeof t.customClass && _(e, t.customClass), t.icon && _(e, g["icon-".concat(t.icon)]) },
        je = (e, t) => {
            var n, o, i;
            (e => {
                var t = f();
    ...
    const Me = e => {
        ...
        De = (e, t) => { var n = O(); const o = T();!t && Q(E()) && (t = E()), J(n), t && ($(t), o.setAttribute("data-button-to-replace", t.className)), o.parentNode.insertBefore(o, t), _([e, n], g.loading) },
        qe = {},
        He = o => new Promise(e => {
            if (!o) return e();
            var t = window.scrollX,
                n = window.scrollY;
            qe.restoreFocusTimeout = setTimeout(() => { qe.previousActiveElement && qe.previousActiveElement.focus ? (qe.previousActiveElement.focus(), qe.previousActiveElement = null) : document.body && document.body.focus(), e() }, 100), window.scrollTo(t, n)
        });
    const Ve = () => {
        ...
        Ne = () => { if (qe.timeout) { var e = qe.timeout.start(); return oe(e), e } };
    let Ue = !1;
    const Fe = {};
    const Re = t => {
            for (let e = t.target; e && e !== document; e = e.parentNode)
                for (const o in Fe) { var n = e.getAttribute(o); if (n) return void Fe[o].fire({ template: n }) }
        },
        ze = {
            title: "",
            titleText: "",
    ...
    const Ge = () => {
        ...
        Qe = () => { navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i) || w().scrollHeight > window.innerHeight - 44 && (f().style.paddingBottom = "".concat(44, "px")) },
        et = () => {
            const e = f();
            let t;
            e.ontouchstart = e => { t = tt(e) }, e.ontouchmove = e => { t && (e.preventDefault(), e.stopPropagation()) }
        },
        tt = e => {
            var t = e.target,
                n = f();
    ...
    const rt = (e, t, n, o, i) => { qe.swalCloseEventFinishedCallback = at.bind(null, e, n, o, i), t.addEventListener(de, function(e) { e.target === t && (qe.swalCloseEventFinishedCallback(), delete qe.swalCloseEventFinishedCallback) }) },
        ct = (e, t) => { setTimeout(() => { c(t), e._destroy() }) };
    ...
    const ht = ["swal-title", "swal-html", "swal-footer"],
        ...
        bt = e => { const o = {}; return a(e.querySelectorAll("swal-param")).forEach(e => { At(e, ["name", "value"]); var t = e.getAttribute("name"); let n = e.getAttribute("value"); "boolean" == typeof ze[t] && "false" === n && (n = !1), "object" == typeof ze[t] && (n = JSON.parse(n)), o[t] = n }), o },
        ft = e => {
            const n = {};
        ...
        Bt = e => {
            ...
            St(t, n, e), setTimeout(() => { Pt(t, n) }, 10), q() && (Et(t, e.scrollbarPadding, o), (() => {
                const e = a(document.body.children);
                e.forEach(e => { e === f() || e.contains(f()) || (e.hasAttribute("aria-hidden") && e.setAttribute("data-previous-aria-hidden", e.getAttribute("aria-hidden")), e.setAttribute("aria-hidden", "true")) })
        ...
        Pt = (e, t) => { de && ne(t) ? (e.style.overflowY = "hidden", t.addEventListener(de, xt)) : e.style.overflowY = "auto" },
        Et = (e, t, n) => {
            var o;
            (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) && !U(document.body, g.iosfix) && (o = document.body.scrollTop, document.body.style.top = "".concat(-1 * o, "px"), _(document.body, g.iosfix), et(), Qe()), t && "hidden" !== n && Ge(), setTimeout(() => { e.scrollTop = 0 })
        },
        St = (e, t, n) => { _(e, n.showClass.backdrop), t.style.setProperty("opacity", "0", "important"), J(t, "grid"), setTimeout(() => { _(t, n.showClass.popup), t.style.removeProperty("opacity") }, 10), _([document.documentElement, document.body], g.shown), n.heightAuto && n.backdrop && !n.toast && _([document.documentElement, document.body], g["height-auto"]) },
        Tt = e => e.checked ? 1 : 0,
        ...
        jt = (t, n) => {
            ...
            d(n.inputOptions) || m(n.inputOptions) ? (Me(E()), p(n.inputOptions).then(e => { t.hideLoading(), i(e) })) : "object" == typeof n.inputOptions ? i(n.inputOptions) : r("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(typeof n.inputOptions))
        },
        It = (t, n) => {
            const o = t.getInput();
            $(o), p(n.inputValue).then(e => { o.value = "number" === n.input ? parseFloat(e) || 0 : "".concat(e), J(o), o.focus(), t.hideLoading() }).catch(e => { r("Error in inputValue promise: ".concat(e)), o.value = "", J(o), o.focus(), t.hideLoading() })
        },
        Mt = {
            select: (e, t, i) => {
        ...
        Vt = (t, n, o, i) => {
            ...
            e.then(e => { t.enableButtons(), t.enableInput(), e ? t.showValidationMessage(e) : ("deny" === i ? Nt : Ft)(t, n, o) })
        },
        Nt = (t, e, n) => {
        ...
        Ft = (t, e, n) => {
            if (e.showLoaderOnConfirm && Me(), e.preConfirm) {
                ...
                o.then(e => { Q(P()) || !1 === e ? t.hideLoading() : Ut(t, void 0 === e ? n : e) })
            } else Ut(t, n)
        },
        Rt = (e, t, n) => {
            const o = D();
        ...
        Kt = (e, t, n) => { t.isComposing || t.target && e.getInput() && t.target.outerHTML === e.getInput().outerHTML && (["textarea", "file"].includes(n.input) || (Ie(), t.preventDefault())) },
        Yt = (e, t) => {
            var n = e.target,
                o = D();
            let i = -1;
        ...
        Jt = (e, t, n) => { u(t.allowEscapeKey) && (e.preventDefault(), n(l.esc)) },
        $t = (t, e, n) => {
            e.popup.onclick = () => {
    ...
    let Xt = !1;
    const Gt = t => { t.popup.onmousedown = () => { t.container.onmouseup = function(e) { t.container.onmouseup = void 0, e.target === t.container && (Xt = !0) } } },
        Qt = t => { t.container.onmousedown = () => { t.popup.onmouseup = function(e) { t.popup.onmouseup = void 0, e.target !== t.popup && !t.popup.contains(e.target) || (Xt = !0) } } },
        en = (n, o, i) => {
    ...
    const tn = (e, t, n) => {
            var o = I();
            $(o), t.timer && (e.timeout = new dt(() => { n("timer"), delete e.timeout }, t.timer), t.timerProgressBar && (J(o), setTimeout(() => { e.timeout && e.timeout.running && oe(t.timer) })))
        },
        nn = (e, t) => { if (!t.toast) return u(t.allowEnterKey) ? void(on(e, t) || Rt(0, -1, 1)) : an() },
    ...
    e = Object.freeze({
        hideLoading: Xe,
        disableLoading: Xe,
        getInput: function(e) { var t = ge.innerParams.get(e || this); return (e = ge.domCache.get(e || this)) ? R(e.popup, t.input) : null },
        close: st,
        closePopup: st,
        closeModal: st,
        closeToast: st,
        ...
        update: function(t) {
            ...
            const o = {};
            Object.keys(t).forEach(e => { ln.isUpdatableParameter(e) ? o[e] = t[e] : s('Invalid parameter to update: "'.concat(e, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js\n\nIf you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md')) }), n = Object.assign({}, n, o), je(this, n), ge.innerParams.set(this, n), Object.defineProperties(this, { params: { value: Object.assign({}, this.params, t), writable: !1, enumerable: !0 } })
        },
        _destroy: function() {
            var e = ge.domCache.get(this),
    ...
    let rn;
    class cn {
        constructor(...e) { "undefined" != typeof window && (rn = this, e = Object.freeze(this.constructor.argsToParams(e)), Object.defineProperties(this, { params: { value: e, writable: !1, enumerable: !0, configurable: !0 } }), e = this._main(this.params), ge.promise.set(this, e)) }
        then(e) { const t = ge.promise.get(this); return t.then(e) } finally(e) { const t = ge.promise.get(this); return t.finally(e) }
    }
    Object.assign(cn.prototype, e), Object.assign(cn, $e), Object.keys(e).forEach(t => { cn[t] = function(...e) { if (rn) return rn[t](...e) } }), cn.DismissReason = l, cn.version = "11.0.7";
    const ln = cn;
